...
|  ### **Performance Metrics** |             MAEMSER²             |                   2.02866.75410.0372                  | Best performance among modelsSlight positive correlation with LN\_IC50 |
|       **Other Models**       |  DummyRegressorDecision Tree etc |                 Higher MAE Negative R²                |                      Poor performance Ineffective                      |
|       **Model Tuning**       |          Hyperparameters         | alpha\_1:0.001alpha\_2:0.2lambda\_1:0.2lambda\_2: 0.2 |                 Optimized using tune\_model() function                 |
|     **Cross-Validation**     | Mean MAEMean MSEMean RMSEMean R² |                2.02626.73292.57440.0389               |                        Limited explanatory power                       |
| **Test Dataset Performance** |             MAERMSER²            |                   2.20172.79600.0213                  |                         Low predictive accuracy                        |
| **Full Dataset Predictions** |           MAEMSERMSER²           |                2.10707.07662.66020.0593               |                   Limited ability to explain variance                  |
...
The Bayesian Ridge model, despite being the best performer, showed limited predictive accuracy for IC50 values, with weak correlation and low R². Further refinement and alternative approaches are needed to improve predictive performance.
